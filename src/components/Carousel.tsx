  ...
  return (
    <div className="w-full" style={{ height: "400px", maxHeight: "400px" }}>
      <Carousel className="w-full  h-[400px] max-h-[400px]">
        <CarouselContent className=" h-[400px] max-h-[400px]">
        ...
        {/* Carousel controls */}
        <CarouselPrevious className="absolute left-4 top-1/2 -translate-y-1/2 z-10 bg-black/40 bg-gradient-to-r from-primary via-pink-500 to-primary text-white hover:bg-black/60" />
        <CarouselNext className="absolute right-4 top-1/2 -translate-y-1/2 z-10 bg-black/40 bg-gradient-to-r from-primary via-pink-500 to-primary text-white hover:bg-black/60" />
      </Carousel>
    </div>
  );
}
