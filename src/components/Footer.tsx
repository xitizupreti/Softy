    ...
    <>
      <div className="pt-5 bg-gradient-to-r from-primary via-pink-500 to-primary ">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center text-center p-4">
          <div className="flex flex-col items-center justify-center p-4 w-[80%] md:w-[50%] lg:w-[30%] mx-auto">
            <p className="text-center text-white text-1xl font-mdeium mt-4">
            ...
            <div className="flex h-16 pt-8 items-center justify-center gap-4">
              {socialLinks.map((link, index) => (
                <a
                  key={index}
                  href={link.href}
                  target="_blank"
                  className="rounded-full p-1 bg-accent/40 hover:bg-accent/40 transition-colors"
                >
                  {link.icon}
                </a>
              ))}
          ...
          <div className="flex items-center justify-evenly p-4 w-[80%] md:w-[50%] lg:w-[30%] mx-auto text-white">
            <div className="flex flex-col h-[200px] justify-around">
              <h1 className="font-bold flex">Quick Links</h1>
              <Hover heading="Home" url="#" />
              <Hover heading="Categories" url="#" />
              <Hover heading="Products" url="#" />
            </div>
            <div className="flex flex-col h-[200px] justify-around">
              <h1 className="font-bold flex">Company</h1>
              <Hover heading="About" url="#" />
              <Hover heading="Contact" url="#" />
              <Hover heading="Dealer Location" url="#" />
            </div>
          </div>
        ...
        <div className="text-center text-gray-300 flex justify-around py-4 text-sm">
          <p>
            © {new Date().getFullYear()} Softy Hygiene Pvt. Ltd. All rights
            reserved.
          </p>
          <p>
